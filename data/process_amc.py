"""
Preprocess the AMC dataset to parquet format
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_name", type=str, default="amc-2023-nosystem-boxed.parquet")
    parser.add_argument("--num_proc", type=int, default=16)
    parser.add_argument("--n_trials", type=int, default=32)
    parser.add_argument("--year", type=int, default=2023, help="AMC year to process")
