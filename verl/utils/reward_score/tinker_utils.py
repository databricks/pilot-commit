...
def grade_answer(given_answer: str, ground_truth: str, timeout_seconds: int = 1) -> bool:
    """
...
def grade_answer_math_verify(given_answer: str, ground_truth: str, timeout_seconds: int = 5) -> bool:
    """
    ...
    given_answer_parsed = parse(given_answer, parsing_timeout=timeout_seconds)
    ground_truth_parsed = parse(ground_truth, parsing_timeout=timeout_seconds)

    is_correct = verify(given_answer_parsed, ground_truth_parsed, timeout_seconds=timeout_seconds)
