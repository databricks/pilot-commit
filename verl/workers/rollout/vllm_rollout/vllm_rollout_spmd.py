...
class vLLMRollout(BaseRollout):
    ...
    def generate_sequences(self, prompts: DataProto, **kwargs) -> DataProto:
        ...
        """
        # keep original data
        prompts.non_tensor_batch["input_ids_original"] = prompts.batch["input_ids"].cpu().numpy()
        prompts.non_tensor_batch["attention_mask_original"] = prompts.batch["attention_mask"].cpu().numpy()
        prompts.non_tensor_batch["position_ids_original"] = prompts.batch["position_ids"].cpu().numpy()
        ...
        if "multi_modal_data" in non_tensor_batch:
            ...
            # don't pop raw_prompt_ids so it can be reused later
            vllm_inputs = [
