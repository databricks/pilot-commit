"""
Preprocess the Minerva Math dataset to parquet format
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_name", type=str, default="minerva-math-nosystem-boxed.parquet")
    ...
    print(f"Loading Minerva Math dataset from {data_source}...", flush=True)
